              ...
              <div className="flex items-center justify-between flex-wrap gap-2 pr-24">
                <div className="flex items-center gap-3">
                  ...
                  {(() => {
                    ...
                    return <Pill color={T.yellow} bg="#FFF6DE">⭐ {avg} rendimiento</Pill>;
                  })()}
                </div>
  ...
  <body>
    ...
    <div class="sheet">
      ...
      <div class="grid3">
        ...
        ${kv("Posiciones secundarias", (p.secundarias || []).join(", "))}
      </div>
  ...
  return (
    <div className="flex flex-col gap-5 max-w-4xl">
      ...
      {[["Jugadores", results.jugadores, (x) => x.nombre], ["Partidos", results.partidos, (x) => `vs ${x.rival} (${x.resultadoFinal})`],
        ["Entrenamientos", results.entrenamientos, (x) => sessionDisplayName(x)], ["Tareas", results.tareas, (x) => `${x.nombre} (${x.codigo})`]].map(([label, arr, fmt]) => (
        arr.length > 0 && (
