                  ...
                  {(() => {
                    ...
                    return (
                      <div className="flex items-center gap-2 flex-wrap">
                        <span className="px-3 py-1 rounded-full text-sm font-bold" style={{ color: T.navy, background: "#E7ECF5" }}>⭐ {avg} rendimiento</span>
                        {mvp && <span className="px-3 py-1 rounded-full text-sm font-bold" style={{ color: "#fff", background: T.red }}>🏅 MVP: {mvp.apodo || mvp.nombre} ({mvpEntry[1]})</span>}
                      </div>
                    );
                  })()}
                </div>
